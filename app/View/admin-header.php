                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="items-center hidden mb-2 lg:block">
                        <ul class="flex flex-row items-center gap-5 mt-2 text-dark-white">
                            ...
                            <li><a href="/admin/schedule">Jadwal</a></li>
                            <li><a href="/admin/nailist">Nailist</a></li>
                            <?php if ($model['admin']->username == "admin") { ?>
                                <li><a href="/admin/admin">Admin</a></li>
                                <li><a href="/admin/register">Tambah Admin</a></li>
                            <?php } ?>
                            <li><a href="/admin/report">Riwayat</a></li>
                            <?php ?>
                        </ul>
                    </div>
                    <div class="hidden lg:block">
                        <div class="flex flex-row gap-2">
                            <a href="/admin/logout" class="hidden px-3 py-2 rounded-full grow bg-abu text-ungu lg:block font-rubik">Logout</a>
                        </div>
                    </div>
                </div>
