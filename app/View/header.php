...
<body class="text-abu font-poppins">
    <!-- Navigation -->
    <nav x-data="{navOpen : false}" class="font-rubik">
        <div class="absolute top-0 left-0 right-0 z-50 items-center px-4 py-4 mx-auto">
            <div class="container mx-auto lg:px-20">
                <div class="flex items-center justify-between">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 lg:hidden sm:order-3 text-abu" @click="navOpen = !navOpen">
                        <path fill-rule="evenodd" d="M3 6.75A.75.75 0 013.75 6h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 6.75zM3 12a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 12zm0 5.25a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75z" clip-rule="evenodd" />
                    </svg>
                    <!-- <img src="<?= getImage('toggle.svg') ?>"> -->
                    <div class="flex items-center gap-3">
                        <a href="/" class="font-rubik text-dark-white sm:order-2 text-[28px]">BYW.STUDIO</a>
                        <!-- <img src="img/LogoSmall.svg" class="sm:order-1"> -->
                    </div>
                    <div class="items-center hidden mb-2 lg:block">
                        <ul class="flex flex-row items-center gap-5 mt-2 text-dark-white">
                            <li><a href="/">Beranda</a></li>
                            <li><a href="/booking/orders">Booking</a></li>
                            <li><a href="/nailist">Nailist</a></li>
                            <li><a href="/catalogue">Katalog</a></li>
                            <li><a href="/about-us">Tentang Kami</a></li>
                        </ul>
                    </div>
                    <div class="hidden lg:block">
                        <?php if (isset($model['customer']) && $model['customer'] != null) { ?>
                            <div class="flex flex-row gap-2">
                                <a href="/customer/booking" class="hidden px-3 py-2 rounded-full grow bg-abu text-ungu lg:block font-rubik">Dashboard</a>
                            </div>
                        <?php } else { ?>
                            <div class="flex flex-row gap-2">
                                <a href="/customer/login" class="hidden px-3 py-2 rounded-full grow lg:block text-dark-white font-rubik">Login</a>
                                <a href="/customer/register" class="hidden px-3 py-2 rounded-full grow bg-abu text-ungu lg:block font-rubik">Daftar</a>
                            </div>
                        <?php } ?>
                    </div>
                </div>
