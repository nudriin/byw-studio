            ...
            <div class="grid items-center justify-center grid-cols-12">
                ...
                <div class="col-span-12">
                    <div class="flex items-center justify-center">
                        <h1 class="mb-4 text-4xl font-rubik">Ubah Jadwal</h1>
                    </div>
                    <form action="/admin/add-schedule" method="post" class="col-span-6">
                        <div class="flex flex-col items-center justify-center gap-3">
                            <div>
                                <input type="date" name="dates" id="" placeholder="Tanggal" value="" class="w-full p-2 border-2 rounded-lg border-abu">
                            </div>
                            <div>
                                <input type="time" name="book_time" id="" placeholder="Jam" class="w-full p-2 border-2 rounded-lg border-abu">
                            </div>
                            <div>
                                <button type="submit" class="w-full p-2 rounded-lg bg-ungu text-dark-white">Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
