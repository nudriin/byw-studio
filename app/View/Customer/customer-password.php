                            ...
                            <div class="flex flex-col items-center justify-center gap-3">
                                <div>
                                    <input type="text" name="username" id="" placeholder="Username"
                                        class="w-full p-2 border-2 rounded-lg border-abu bg-abu text-ungu" value="<?= $model['customer']->username?>" disabled>
                                </div>
                                <div>
                                    <input type="password" name="old_password" id="" placeholder="Old password"
                                        class="w-full p-2 border-2 rounded-lg border-abu" required">
                                </div>
                                <div>
                                    <input type="password" name="new_password" id="" placeholder="New password"
                                        class="w-full p-2 border-2 rounded-lg border-abu">
                                </div>
                                <div>
                                    <button type="submit"
                                        class="w-full p-2 bg-abu text-ungu font-rubik rounded-[15px]">Ganti Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
