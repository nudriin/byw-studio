            ...
            <div class="grid items-center justify-center grid-cols-12">
                ...
                <div class="col-span-6">
                    <div class="flex items-center justify-center">
                        <h1 class="mb-4 text-4xl font-rubik">Daftar</h1>
                    </div>
                    <form action="/customer/register" method="post" class="col-span-6">
                        <div class="flex flex-col items-center justify-center gap-3">
                            <div>
                                <input type="text" name="username" id="" placeholder="Username" class="w-full p-2 border-2 rounded-lg border-abu">
                            </div>
                            <div>
                                <input type="text" name="name" id="" placeholder="Name" class="w-full p-2 border-2 rounded-lg border-abu">
                            </div>
                            <div>
                                <input type="number" min="0" name="phone" id="" placeholder="Phone" class="w-full p-2 border-2 rounded-lg border-abu">
                            </div>
                            <div>
                                <input type="password" name="password" id="" placeholder="Password" class="w-full p-2 border-2 rounded-lg border-abu">
                            </div>
                            <div>
                                <button type="submit" class="w-full p-2 bg-abu text-ungu font-rubik rounded-[15px]">Daftar</button>
                            </div>
                        </div>
                    </form>
                </div>
