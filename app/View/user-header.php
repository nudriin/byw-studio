            ...
            <div class="container mx-auto lg:px-20">
                <div class="flex items-center justify-between">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        class="w-6 h-6 lg:hidden sm:order-3 text-abu" @click="navOpen = !navOpen">
                    ...
                    <div class="items-center hidden mb-2 lg:block">
                        <ul class="flex flex-row items-center gap-5 mt-2 text-dark-white">
                            ...
                            <li><a href="/customer/password">Password</a></li>
                            <li><a href="/customer/booking-history">Riwayat Booking</a></li>
                        </ul>
                    </div>
                    <div class="hidden lg:block">
                        <div class="flex flex-row gap-2">
                            <a href="/customer/logout"
                                class="hidden px-3 py-2 rounded-full grow bg-abu text-ungu lg:block font-rubik">Logout</a>
                        </div>
                    </div>
                </div>
