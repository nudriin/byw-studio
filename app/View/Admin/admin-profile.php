        ...
        <div class="w-9/12 bg-white shadow-md p-6 rounded-[20px] mx-auto">
            <div class="grid items-center justify-center grid-cols-12">
                ...
                <div class="col-span-12">
                    ...
                    <form action="/admin/profile" method="post" class="col-span-6">
                        <div class="flex flex-col items-center justify-center gap-3">
                            ...
                            <div>
                                <input type="text" name="name" id="" placeholder="Name" class="w-full p-2 border-2 rounded-lg border-abu" required value="<?= $model['admin']->name ?? $model['post_name'] ?>">
                            </div>
                            <div>
