    ...
    <div class="container mx-auto lg:py-28">
        <div class="w-9/12 mx-auto ">
            ...
            <?php if (isset($model['orders']) && $model['orders'] != null && !isset($model['error'])) { ?>
                <div class="w-full mx-auto rounded-[20px] overflow-hidden" style="overflow: auto;">
                    <table class="w-full font-rubik">
                        ...
                        <tbody class="text-gray-600">
                            ...
                            foreach ($model['orders'] as $row) {
                                $i++; ?>
                                <?php if ($row['status'] != "Selesai" && $row['book_time'] != null) { ?>
                                    <form action="/admin/booking" method="post">
                                        <tr class="border-b hover:bg-dark-white">
                                            ...
                                            <td class="flex flex-col py-2 text-center bg-white">
                                                <h1 style="color: blue; text-decoration: underline; cursor: pointer;" onclick="openPopup()">Lihat</h1>
                                            </td>
                                            <td class="py-2 text-center bg-white">
                                                <input type="hidden" name="orders_id" value="<?= $row['id'] ?>">
                                    ...
                                    <div class="flex items-center popup" id="myPopup">
                                        <div class="popup-content">
                                            <span class="close" onclick="closePopup()">&times;</span>
                                            <img src="<?= getUploadedImg("payment/$row[payment_confirm]") ?>" class="object-cover object-center mx-auto" style="height: 480px; border-radius: 15px;" alt="">
