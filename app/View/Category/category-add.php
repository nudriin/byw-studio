    ...
    <div class="container py-20 mx-auto">
        ...
        <div class="w-9/12 mx-auto">
            <div class="max-w-md mx-auto bg-white p-6 rounded-[20px] shadow-md">
                <h2 class="mb-6 text-2xl font-medium font-rubik text-abu">Tambah Kategori</h2>
                ...
                <form action="/admin/add-category" method="post" class="">
                    ...
                    <div class="mb-4">
                        <label for="kategori" class="block mb-2 font-semibold text-abu">Nama
                            Kategori</label>
                        <input type="text" id="kategori" name="name" class="w-full px-4 py-2 border-2 rounded-md border-abu focus:outline-none focus:border-red-600" placeholder="Masukkan nama kategori" required>
                    </div>

                    <!-- Tombol Submit -->
                    <div class="flex justify-end">
                        <button type="submit" class="px-4 py-2 rounded-lg bg-abu font-rubik text-ungu hover:shadow-md">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
